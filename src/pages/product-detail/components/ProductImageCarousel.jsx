      ...
      {images.length > 1 && (
        <>
          <Button
            ...
            size="icon"
            onClick={prevImage}
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-black/20 backdrop-blur-xs text-white hover:bg-black/40 hidden md:flex"
          ...
          <Button
            ...
            size="icon"
            onClick={nextImage}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-black/20 backdrop-blur-xs text-white hover:bg-black/40 hidden md:flex"
            style={{ width: '44px', height: '44px' }}
          >
