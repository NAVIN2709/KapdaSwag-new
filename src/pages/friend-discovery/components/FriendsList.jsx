...
const FriendsList = () => {
  ...
  if (loading) {
    return (
      <div className="p-1 flex flex-col items-center text-gray-400">
        <h2 className="text-lg font-bold mb-4 text-white flex justify-start w-[100%]">Your Swag Circle</h2>
